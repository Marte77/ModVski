...
public class StructuresConfigured {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_CASA_DOS_YOUTUBERS = StructuresInit.CASA_DOS_YOUTUBERS.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(modvski.MODID, "configured_run_down_house"), CONFIGURED_CASA_DOS_YOUTUBERS);
