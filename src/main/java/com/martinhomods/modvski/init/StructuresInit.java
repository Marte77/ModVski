...
import com.martinhomods.modvski.world.structures.casa_dos_youtubersPieces;
import com.martinhomods.modvski.world.structures.casa_dos_youtubersStructure;
...
public class StructuresInit {
     ...
     */
    public static final DeferredRegister<Structure<?>> ESTRUTURAS = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, modvski.MODID);
    /**
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> CASA_DOS_YOUTUBERS = ESTRUTURAS.register("casa_dos_youtubers", () -> (new casa_dos_youtubersStructure(NoFeatureConfig.CODEC)));
    public static IStructurePieceType CASA_DOS_YOUTUBERS_PIECE = casa_dos_youtubersPieces.Piece::new;
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                CASA_DOS_YOUTUBERS.get(), /* The instance of the structure */
